...
def _append_pending_indices(designer: Any, region_indices: list[int]) -> None:
...
def commit_selection(designer: Any, commit: SelectionCommit) -> None:
    state = designer._state
...
def _restore_rng_states(designer: Any, state: dict) -> None:
...
def _load_shared_region_data(*, designer: Any, runtime, data: list) -> None:
...
def _load_region_child_states(*, designer: Any, state: dict, runtime) -> None:
...
def load_multi_state(designer: Any, state: dict, data: list) -> None:
...
def _tell_new_data_if_any(designer: Any, data: list) -> None:
    state = designer._state
