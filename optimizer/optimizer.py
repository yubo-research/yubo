...
class Optimizer:
    def __init__(self, env_conf, policy, num_arms, cb_trace=None):
        ...
        self._designers = {
            ...
            "ieig_ts": BTDesigner(policy, AcqIEIG, init_sobol=0, acq_kwargs={"use_cem": False, "q_ts": num_arms, 'num_px_samples': 256, }),
            "cem_ts": BTDesigner(policy, AcqIEIG, init_sobol=0, acq_kwargs={"use_cem": True, "q_ts": num_arms, 'num_px_samples': 256, }),
