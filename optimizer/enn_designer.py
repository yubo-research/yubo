...
class ENNDesigner:
    def __init__(self, policy, enn_config: ENNConfig, num_keep: int = None, keep_style: str = None, want_descriptors: bool = False):
        self._policy = policy
        self._enn_config = enn_config
        self._num_keep = num_keep
        self._keep_style = keep_style
        self._want_descriptors = want_descriptors
        self._i_data_last = 0
