...
def register_all() -> None:
    ...
    _register_lazy_once("wpo", "rl.torchrl.wpo.trainer")
    _register_lazy_once("wpo", "rl.pufferlib.wpo.engine", backend="pufferlib")
    ...
    register_algo_backend("wpo", "torchrl", "wpo")
    register_algo_backend("wpo", "pufferlib", "wpo")
