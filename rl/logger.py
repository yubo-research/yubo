...
def log_run_header(algo_name: str, config: Any, env: Any, training: Any, runtime: Any, *, prefix: str = "") -> None:
...
def log_progress_iteration(
    iteration: int, num_iterations: int, frames_per_batch: int, elapsed: float, *, algo_name: str = "ppo", step_override: int | None = None, prefix: str = ""
) -> None:
    print_iteration_simple(iteration, num_iterations, frames_per_batch, elapsed, algo_name=algo_name, step_override=step_override, prefix=prefix)


def log_run_footer(best_return: float, total_iters_or_steps: int, total_time: float, *, algo_name: str = "ppo", step_label: str = "iters") -> None:
    print_run_footer(best_return, total_iters_or_steps, total_time, algo_name=algo_name, step_label=step_label)
