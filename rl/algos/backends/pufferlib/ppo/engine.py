...
from rl.algos.backends.pufferlib.ppo import checkpoint as puffer_ckpt
from rl.algos.backends.pufferlib.ppo import eval as puffer_eval
from rl.algos.backends.pufferlib.ppo import eval_config as puffer_eval_config
from rl.algos.backends.pufferlib.ppo import metrics as puffer_metrics
from rl.algos.backends.pufferlib.ppo.config import PufferPPOConfig, TrainResult
from rl.algos.backends.pufferlib.ppo.specs import (
    _ActionSpec,
    _ActorCritic,
    _FlatBatch,
    _ObservationSpec,
...
def _run_training(
    ...
    *,
    ...
    checkpointing = __import__("rl.algos.checkpointing", fromlist=["CheckpointManager"])
...
def train_ppo_puffer_impl(
    ...
    *,
    ...
    if make_vector_env_fn is None:
        compat = __import__("rl.algos.pufferlib_compat", fromlist=["import_pufferlib_modules"])
