...
from problems.pre_obj_hyperscalees import (
    HyperscaleESLLMVectorObjective as HyperscaleESLLMVectorObjective,
)
from problems.pre_obj_nanoegg import (
    NanoEggPretrainVectorObjective as NanoEggPretrainVectorObjective,
)
...
from problems.pre_obj_specs import (
    is_hyperscalees_pretrain_env as is_hyperscalees_pretrain_env,
)
from problems.pre_obj_specs import is_nanoegg_pretrain_env as is_nanoegg_pretrain_env
from problems.pre_obj_specs import (
    resolve_hyperscalees_pretrain_spec as resolve_hyperscalees_pretrain_spec,
)
from problems.pre_obj_specs import (
    resolve_nanoegg_policy_spec as resolve_nanoegg_policy_spec,
)
from problems.pre_obj_specs import (
    resolve_nanoegg_pretrain_spec as resolve_nanoegg_pretrain_spec,
)
from problems.pre_obj_specs import (
    supported_hyperscalees_llm_bandit_tasks as supported_hyperscalees_llm_bandit_tasks,
)
