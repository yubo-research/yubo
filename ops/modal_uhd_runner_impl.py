    ...
    def _run_uhd(
        ...
        loop = make_loop(
            ...
            enn={
                ...
                "enn_err_ema_beta": enn_err_ema_beta,
                "enn_max_abs_err_ema": enn_max_abs_err_ema,
                "enn_min_calib_points": enn_min_calib_points,
            },
        )
        buf = io.StringIO()
    ...
    with modal.enable_output():
        with app.run():
            return _run_uhd.remote(
                ...
                str(enn_f.embedder),
                int(enn_f.gather_t),
                float(enn_f.err_ema_beta),
                float(enn_f.max_abs_err_ema),
                int(enn_f.min_calib_points),
            )
